document.addEventListener("DOMContentLoaded", function() {
    ...
    const translations = {
        it: {
            ...
            'service-4-desc': '<br>GUIDA E SUPPORTO AD OPERAZIONI DI LOGISTICA INTEGRATA<br><br>La governance del ciclo dell\'ordine',
            'service-5-title': 'IIC UAE ADVISOR',
            'service-5-desc': 'Punto di riferimento per le aziende italiane di eccellenza. Leadership per il progetto di internazionalizzazione. Interfaccia certificata della camera di commercio in UAE<br>',
            ...
            'footer-viale': 'Viale Papa Giovanni Paolo II, 29. Arconate (MI), 20020, Lombardia',
        ...
        en: {
            ...
            'service-4-desc': '<br>GUIDE AND SUPPORT FOR INTEGRATED LOGISTICS OPERATIONS<br><br>Order cycle governance',
            'service-5-title': 'IIC UAE ADVISOR',
            'service-5-desc': 'Reference point for Italian excellence companies. Leadership for the internationalization project. Certified interface of the chamber of commerce in UAE<br>',
